...
def main():
    ...
    print(Fore.LIGHTBLUE_EX + "Cara Menggunakannya: ")
    print(Fore.LIGHTBLUE_EX + "1. Login akun tiktokmu di browser")
    print(Fore.LIGHTBLUE_EX + "2. Pilih video yang akan di salin linknya")
    print(Fore.LIGHTBLUE_EX + "3. Ubah link video tiktokmu"
    )
