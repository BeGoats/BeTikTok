...
def main():
    ...
    print(Fore.LIGHTRED_EX + "Halo, Selamat Datang")
    
    print(Force.LIGHTYELLOW_EX + "Cara Menggunakannya: ")
    print(Force.LIGHTYELLOW_EX + "1. Login akun tiktokmu di browser")
    print(Force.LIGHTYELLOW_EX + "2. Pilih video yang akan di salin linknya")
    print(Force.LIGHTYELLOW_EX + "3. Ubah link video tiktokmu")
    print(Force.LIGHTRED_EX + "Contoh : https://www.tiktok.com/@bukanranggaya/video/7102947441078504731?is_from_webapp=1&sender_device=mobile&sender_web_id=7145515814015354370")
    print(Force.LIGHTGREEN_EX + "Menjadi : https://www.tiktok.com/@bukanranggaya/video/7102947441078504731")
          
    print(Force.RED_EX + "*Note: Jika stuck pada captcha, ketik CTRL+C lalu exit dan mulai ulang scriptnya")
