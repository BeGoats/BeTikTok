...
def main():
    ...
    print(Force.LIGHTYELLOW_EX + "Cara Menggunakannya:
          1. Login akun tiktokmu di browser
          2. Pilih video yang akan di salin linknya
          3. Ubah link video tiktokmu
             Contoh : https://www.tiktok.com/@bukanranggaya/video/7102947441078504731
                      ?is_from_webapp=1&sender_device=mobile&sender_web_id=7145515814015354370
            Menjadi : https://www.tiktok.com/@bukanranggaya/video/7102947441078504731")
          
    print(Force.LIGHTRED_EX + "*Note: Jika stuck pada captcha, ketik CTRL+C lalu exit
                                LaLu mulai ulang scriptnya")
