...
def main():
    ...
    print(Fore.LIGHTRED_EX + "Contoh : https://www.tiktok.com/@bukanranggaya/video/7102947441078504731?is_from_webapp=1&sender_device=mobile&sender_web_id=7145515814015354370")
    print(Fore.LIGHTGREEN_EX + "Menjadi : https://www.tiktok.com/@bukanranggaya/video/7102947441078504731")
          
    print(Fore.RED_EX + "*Note: Jika stuck pada captcha, ketik CTRL+C lalu exit dan mulai ulang scriptnya")
